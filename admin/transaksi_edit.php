    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                // mengambil data pelanggan dari tabel transaksi
                ...
                <form method="post" action="transaksi_update.php">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control" name="jenis_pakaian[]" value="<?php echo $p['pakaian_jenis']; ?>">
                            </td>
                            <td>
                                <input type="number" class="form-control" name="jumlah_pakaian[]" value="<?php echo $p['pakaian_jumlah']; ?>">
                            </td>
                        </tr>
                        <?php } ?>
